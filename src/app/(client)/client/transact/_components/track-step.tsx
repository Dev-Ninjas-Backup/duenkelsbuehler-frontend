      ...
      {selected === null ? (
        <>
          <motion.p
            ...
            className="font-work-sans text-[13px] lg:text-sm text-[#414651] text-center mb-6 shrink-0 px-4"
          >
        ...
        <motion.div
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 0.25 }}
          className="mt-6 max-w-lg mx-auto w-full px-2"
        >
          <div className="bg-[#F9F9F9] rounded-[20px] px-4 sm:px-6 py-6 sm:py-8 border border-gray-100/80">
            <div className="flex items-start justify-between relative">
              {/* Connector line */}
              <div className="absolute top-4 left-[16.67%] right-[16.67%] h-0.5 bg-gray-200 z-0" />
              {STEPS.map((label, i) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-8 h-8 sm:w-9 sm:h-9 rounded-full flex items-center justify-center font-work-sans text-sm font-bold shadow-sm ${
                        isActive
                    ...
                    <span
                      className={`font-work-sans text-[11px] sm:text-xs font-medium text-center leading-tight ${
