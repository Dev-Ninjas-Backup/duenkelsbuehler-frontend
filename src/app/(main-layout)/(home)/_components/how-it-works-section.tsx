...
export function HowItWorksSection() {
  return (
    <section id="how-it-works" className="bg-[#00D05A] text-white px-6 md:px-12 lg:px-24 py-20 lg:py-32 overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-20 items-start">
          ...
          <div className="flex-1">
            ...
            <div className="space-y-14 text-base">
              ...
              >
                <span className="text-[72px] md:text-[96px] font-bold font-rozha leading-none -mt-4 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6 inline-block select-none text-white origin-center">1</span>
              ...
              <motion.div
                ...
                className="flex gap-8 items-start group"
              >
                <span className="text-[72px] md:text-[96px] font-bold font-rozha leading-none -mt-4 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6 inline-block select-none text-white origin-center">2</span>
              ...
              <motion.div
                ...
                className="flex gap-8 items-start group"
              >
                <span className="text-[72px] md:text-[96px] font-bold font-rozha leading-none -mt-4 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6 inline-block select-none text-white origin-center">3</span>
                <p className="text-[18px] md:text-[20px] leading-[1.4] max-w-lg mt-3">
