...
const PRIVACY_POLICY_UUID = "b2b37601-ae46-4ccd-abe7-fe521a13cbd8";
const PRIVACY_POLICY_URL = `https://app.termly.io/policy-viewer/policy.html?policyUUID=${PRIVACY_POLICY_UUID}`;
