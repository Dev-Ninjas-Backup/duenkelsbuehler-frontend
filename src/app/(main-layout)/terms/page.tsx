        ...
        >
          <section id="introduction" className="mb-14 lg:mb-20 scroll-mt-32">
            ...
            <p className="leading-loose mb-5 text-base md:text-lg">
              Welcome to AristoPay. By accessing or using our platform, you
              agree to be bound by these Terms of Service. These terms govern
              your usage of all AristoPay services, interactions, and financial
              transactions.
            </p>
            <p className="leading-loose mb-5 text-base md:text-lg">
              If you disagree with any part of the terms, you may not access our
              service. We reserve the right to review and update these terms at
              our sole discretion. It is your responsibility to periodically
              check this document for any revisions.
            </p>
          </section>
          ...
          >
            ...
            <p className="leading-loose mb-5 text-base md:text-lg">
              To utilize complete platform features, users must perform
              verification. The &quot;AristoAccess+&quot; system verifies the
              identity of Service Providers to increase client trust.
            </p>
            <p className="leading-loose mb-5 text-base md:text-lg">
              Providing false information during verification constitutes a
              material breach of these terms and will result in immediate
              termination of account access, alongside any potential legal
              action prescribed by governing authority.
            </p>
          </section>
          ...
          <section id="platform-usage" className="mb-14 lg:mb-20 scroll-mt-32">
            ...
            <p className="leading-loose mb-5 text-base md:text-lg">
              You agree to use our platform strictly for lawful purposes.
              Harassment, abuse, explicit content, and spamming are strictly
              prohibited and will be met with a zero-tolerance policy.
            </p>
            <ul className="list-disc pl-6 mb-5 space-y-3 text-base md:text-lg">
              <li>
                <strong className="text-[#181D27]">Exclusivity:</strong> Do not
                circumvent platform payment systems to conduct transactions
                established via AristoPay.
              </li>
              <li>
                <strong className="text-[#181D27]">Professionalism:</strong>{" "}
                Always maintain professional and courteous communication with
                all users.
              </li>
              <li>
                <strong className="text-[#181D27]">Integrity:</strong> Respect
                the privacy and intellectual property rights of other platform
                users.
              </li>
            </ul>
          </section>
          ...
          <section id="payments-fees" className="mb-14 lg:mb-20 scroll-mt-32">
            ...
            <p className="leading-loose mb-5 text-base md:text-lg">
              All payments facilitated via AristoPay are subject to platform
              service fees as outlined in our Fee Schedule. Invoices generated
              must accurately reflect the services rendered.
            </p>
            <p className="leading-loose mb-5 text-base md:text-lg">
              Chargebacks and payment disputes are handled by our internal
              resolution center. We strongly recommend tracking all project
              milestones carefully to ensure you are fully protected under our
          ...
          >
            ...
            <p className="leading-loose mb-5 text-base md:text-lg">
              Unless otherwise specified in a specific project contract, Service
              Providers retain intellectual property rights until full payment
              has been disbursed. Upon successful payment settlement, the
              relevant rights transfer entirely to the client as configured in
              the project scope.
            </p>
          </section>
          ...
          <section id="termination" className="mb-14 lg:mb-20 scroll-mt-32">
            ...
            <p className="leading-loose mb-5 text-base md:text-lg">
              AristoPay reserves the right to suspend or terminate accounts that
              violate our policies without prior written notice, though we
              typically strive to communicate warnings where possible.
            </p>
          </section>
          ...
          <section id="limitation" className="mb-14 lg:mb-20 scroll-mt-32">
            ...
            <p className="leading-loose mb-5 text-base md:text-lg">
              Under no circumstances shall AristoPay be liable for indirect,
              incidental, or consequential damages resulting from lost data,
              lost profits, or business interruptions attributed directly to the
              unexpected failure of the platform.
            </p>
          </section>
          ...
          <section id="changes" className="mb-14 lg:mb-20 scroll-mt-32">
            ...
            <p className="leading-loose mb-5 text-base md:text-lg">
              When updates are made, the "Last updated" date will reflect the
              revision. Continued use of the platform after changes implies
              consent to the revised terms. We encourage frequent review of
              these policies.
            </p>
          </section>
        </motion.div>
